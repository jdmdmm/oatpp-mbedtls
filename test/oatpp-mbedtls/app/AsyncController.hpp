...
#ifndef oatpp_test_web_app_AsyncController_hpp
#define oatpp_test_web_app_AsyncController_hpp
...
private:
  static constexpr const char* TAG = "test::web::app::AsyncController";
public:
...
public:
  ...
  static std::shared_ptr<AsyncController> createShared(const std::shared_ptr<ObjectMapper>& objectMapper = OATPP_GET_COMPONENT(std::shared_ptr<ObjectMapper>)){
    return std::make_shared<AsyncController>(objectMapper);
  }
...
#endif /* oatpp_test_web_app_AsyncController_hpp */
